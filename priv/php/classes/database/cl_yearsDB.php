...
require_once CLASSES_PATH . '/business/Year.php';
...
/*    public function getAllYears()
    {
        try {
            ...
            while ($stmt->fetch()) {
                $yearUnit = new Year($idyeaR, $iddecaR, $decadeR, $yearR);
    ...
    {
        require_once CLASSES_PATH . '/business/Decade.php';
        include INCLUDES_PATH . 'db_connect.php';
    ...
    function getYearsSelected($decade)
    {
        try {
            ...
            $yearArray = [];
            while ($stmt->fetch()) {
                $year = new Year($idyeaR, $iddecaR, $decadeR, $yearR);
