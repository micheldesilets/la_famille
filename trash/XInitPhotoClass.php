...
include_once 'XGeneologyNamesList.php';
include_once 'XGeneologyIndexesList.php';
...
class InitPhotoClass
{
    ...
    public function setToClass($id, $titlePho, $keywords, $caption,
                               ...
                               $titleFol, $year)
    {
        $this->namesList = new GeneologyNamesList();
        $this->indexesList=new GeneologyIndexesList();
        $photo = new Photos();
