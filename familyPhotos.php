...
<div class="page ">
    ...
    <div class="search">
        <section class="search__section">
            ...
            <form action="javascript:searchInputs()" class="search__keyword">
                <fieldset class="search__fieldset">
                    ...
                    <div class="search__check-box">
                        ...
                        <input type="checkbox"
                               ...
                               value="titres"
                               checked>
                        <label for="search__titles" class="search__cb-label">Recherche
                            des titres</label>
                        <br>
                        <input type="checkbox"
                               id="search__comments"
                               value="commentaires"
                               checked>
                        <label for="search__comments" class="search__cb-label">Recherche
    ...
    <div class="photos">
        ...
        <section>
            ...
            <div class="photos__modal">
                ...
                <img src="assets/img/icons/iconfinder_Streamline-22_185042.png"
